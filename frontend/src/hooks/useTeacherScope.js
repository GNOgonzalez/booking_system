...
export function staffPathsForTeacher(teacherId) {
  ...
  return {
    ...
    curriculumSuggestions: (studentId) => `${base}/curriculum/students/${studentId}/suggestions/`,
    curriculumSuggest: (studentId) => `${base}/curriculum/students/${studentId}/suggest/`,
    curriculumSummary: (studentId) => `${base}/curriculum/students/${studentId}/summary/`,
    curriculumSuggestionAccept: (suggestionId) => `${base}/curriculum/suggestions/${suggestionId}/accept/`,
    curriculumSuggestionDismiss: (suggestionId) => `${base}/curriculum/suggestions/${suggestionId}/dismiss/`,
    ...
    curriculumPage: `/staff/teachers/${teacherId}/curriculum`,
    staffHome: '/staff',
...
const TEACHER_SELF_PATHS = {
  ...
  curriculumSuggestions: (studentId) => `/api/teacher/curriculum/students/${studentId}/suggestions/`,
  curriculumSuggest: (studentId) => `/api/teacher/curriculum/students/${studentId}/suggest/`,
  curriculumSummary: (studentId) => `/api/teacher/curriculum/students/${studentId}/summary/`,
  curriculumSuggestionAccept: (suggestionId) => `/api/teacher/curriculum/suggestions/${suggestionId}/accept/`,
  curriculumSuggestionDismiss: (suggestionId) => `/api/teacher/curriculum/suggestions/${suggestionId}/dismiss/`,
  ...
  curriculumPage: '/teacher/curriculum',
  staffHome: '/staff',
